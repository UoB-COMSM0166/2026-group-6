...
| Sprint  | Time       | Goal |  snapshot |
|---------|------------|------|  -------- |
| Sprint 1 | Week 3–6  | Generate the first version of the demo (one difficulty level) | <img src="resources/images/week4-snapshot.png" width="50%"/>|
| Sprint 2 | Week 7–8  | Add two difficulty levels and expand functionality |<img src="resources/images/week7-snapshot.png" width="50%"/>|
| Sprint 3 | Week 9–10 | Improve the UI system and enhance user experience |<img src="resources/images/week-end-snapshot.png" width="50%"/>|
...
We used AI to create the game's cover and the opening and ending still animation picture.
